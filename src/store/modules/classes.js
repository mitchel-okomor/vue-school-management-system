import { ADD_CLASS, GET_CLASS, EDIT_CLASS, DELETE_CLASS, SET_CLASS} from "../../helpers/mutationConstants";
...
export default {
  ...
  mutations: {
    ...
    [EDIT_CLASS](state, subject_class) {
      const item = state.classes.findIndex(item => item._id === subject_class._id);
