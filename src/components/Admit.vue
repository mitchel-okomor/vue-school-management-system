<template>
  <main class="admit d-flex justify-content-center">
        <form class="" action="#"  @submit.prevent="registerStudent(firstname, lastname, address, state_of_origin, state_of_residence, phone, email, password, date_of_birth, subject_class, passport, confirm_password)">
   <div class="form-row">
  ...
  <div class="form-row">
   ...
   <div class="form-row">
    ...
    <input type="password" class="form-control"  placeholder="Password" v-model="confirm_password">
    </div>
   </div>
    <div class="form-row">
  <div class="form-group col-md-6">
...
<input type="file"  placeholder="passport" v-on:change="handleFileUpload"/>  </div>
  </div>
...
methods: {
 ...
 handleFileUpload(e){
  ...
  registerStudent(firstname, lastname, address, state_of_residence, state_of_origin , phone, email, password, date_of_birth, subject_class, passport, confirm_password){
